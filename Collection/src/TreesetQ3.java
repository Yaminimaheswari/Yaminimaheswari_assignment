...
public class TreesetQ3 {
    ...
    public static void main(String[] args) {
        ...
        s.add(new Employees ("mahi",123,50000,"Dev"));
        s.add(new Employees ("jay",456,60000,"HR"));
        s.add(new Employees ("Adhi",789,30000,"Mgmt"));
        s.add(new Employees("Gowthami",111,90000,"Mgmt"));
        s.add(new Employees("Deva",222,10000,"Dev"));
