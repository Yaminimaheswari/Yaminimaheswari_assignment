...
public class Tree {
    public static void main(String[] args) {
        ...
        contact a1=new contact(a,"mahi","rock@gmail.com",Gender.male);
        contact a2=new contact(b,"sri","lily@gmail.com",Gender.female);
        contact a3=new contact(c,"ayesha","new@gmail.com",Gender.male);
        contact a4=new contact(d,"ramya","con@gmail.com",Gender.male);
